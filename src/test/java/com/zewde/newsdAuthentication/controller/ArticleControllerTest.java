...
public class ArticleControllerTest {
  ...
  public void getArticlesPerUser() throws Exception {
    Article article1 = new Article(1,"first source","first author","first Article", "first description","first url", "first url to image", "2020-04-09", "first  content");
    Article article2 = new Article(2,"some second source","some  second author","some second title", "some second description","some second url", "some second url to image", "2020-04-09", "some second more content");
